...
class SimulationGUI:
    def __init__(self, root, simulator, steps=500, delay=0.5):
        ...
        self.description.insert(tk.END,
            ...
            "• Top-left: Local Temperature 🌡️\n"
            "  Information processing activity\n\n"
            "• Top-right: Info Fragments 🧩\n"
            "  Entropy accumulation\n\n"
            "• Bottom-left: Observation Density 👁️\n"
...
"""
    ...
    def update_plots(self, temp_matrix, frag_matrix, obs_matrix, bh_locs, ent_locs):
        ...
        draw_matrix(self.ax_temp, temp_matrix, "🌡️ Local Temperature", 'inferno', SPECIAL_OBS_COLOR, self.max_temp_val, 'temp', 'Temperature (Hot)', bh_locs, ent_locs)
        ...
        draw_matrix(self.ax_obs, obs_matrix, "👁️ Observation Density", 'plasma', ACCENT_SECONDARY, self.max_obs_val, 'obs', 'Observations (Fixed Reality)', bh_locs, ent_locs)
